...
reference documents `data-raw/BC_2006.pdf` (*British Columbia Approved Water Quality Guidelines 2006 Edition*) and `data-raw/EMAIL_2014.pdf`
...
- Form - Notes on the specific form where inclusion in the variable name seems too specific.
...
- Reference - The reference document where the only permitted values are BC_2006 and EMAIL_2014.
